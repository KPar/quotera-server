...
const createReflection = (userID, bookID, quote, reflection, category, isPublished) => {
    return db.pool.query(`INSERT INTO reflections(user_id, book_id, quote, reflection, 
        category, date_modified, is_published) VALUES 
        (${userID},${bookID},'${quote}','${reflection}','${category}', current_timestamp, '${isPublished}')`);
}
